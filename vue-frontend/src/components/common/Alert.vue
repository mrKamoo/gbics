    ...
    >
      <div class="flex items-start">
        ...
        <div class="flex-shrink-0">
          ...
          <svg v-else-if="type === 'error' || type === 'danger'" class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
            <path
              fill-rule="evenodd"
...
const titleClasses = computed(() => {
  const classes = {
    success: 'text-green-800 font-medium text-sm',
    error: 'text-red-800 font-medium text-sm',
    danger: 'text-red-800 font-medium text-sm',
...
const closeButtonClasses = computed(() => {
  ...
  return `${classes[props.type]} focus:outline-none`
})
